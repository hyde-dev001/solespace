      ...
      <section className="w-full bg-white py-24 lg:py-32">
        <div className="max-w-[1920px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            {/* Product Card 1 */}
            <div className="group bg-white border-2 border-black overflow-hidden hover:shadow-2xl transition-all duration-300">
              ...
              <div className="p-8 border-t-2 border-black">
                <h3 className="text-2xl font-bold text-black mb-3 uppercase tracking-wide">Running Shoes</h3>
                <p className="text-black/70 mb-6 text-sm leading-relaxed">Premium running shoes engineered for maximum comfort and performance.</p>
                <div className="flex justify-between items-center">
                  <span className="text-3xl font-bold text-black">₱2,500</span>
                  <button className="px-6 py-3 bg-black text-white font-semibold uppercase tracking-wider text-xs hover:bg-black/80 transition-colors">
                    Add to Cart
                  </button>
                </div>
              </div>
            ...
            <div className="group bg-white border-2 border-black overflow-hidden hover:shadow-2xl transition-all duration-300">
              ...
              <div className="p-8 border-t-2 border-black">
                <h3 className="text-2xl font-bold text-black mb-3 uppercase tracking-wide">Casual Sneakers</h3>
                <p className="text-black/70 mb-6 text-sm leading-relaxed">Stylish and versatile sneakers perfect for everyday urban adventures.</p>
                <div className="flex justify-between items-center">
                  <span className="text-3xl font-bold text-black">₱1,800</span>
                  <button className="px-6 py-3 bg-black text-white font-semibold uppercase tracking-wider text-xs hover:bg-black/80 transition-colors">
                    Add to Cart
                  </button>
                </div>
            ...
            <div className="group bg-white border-2 border-black overflow-hidden hover:shadow-2xl transition-all duration-300">
              <div className="relative bg-white overflow-hidden aspect-square">
                <img
                  src="./images/product/product-08.jpg"
                  alt="Formal Shoes"
                  className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                  loading="lazy"
                />
              ...
              <div className="p-8 border-t-2 border-black">
                <h3 className="text-2xl font-bold text-black mb-3 uppercase tracking-wide">Formal Shoes</h3>
                <p className="text-black/70 mb-6 text-sm leading-relaxed">Elegant formal footwear crafted for professional excellence.</p>
                <div className="flex justify-between items-center">
                  <span className="text-3xl font-bold text-black">₱3,200</span>
                  <button className="px-6 py-3 bg-black text-white font-semibold uppercase tracking-wider text-xs hover:bg-black/80 transition-colors">
                    Add to Cart
                  </button>
                </div>
        ...
        <div className="max-w-[1920px] mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-2">
              <Link href={route("landing")} className="text-2xl font-bold text-white mb-6 inline-block">
                SoleSpace
              </Link>
              ...
              <div className="flex gap-4">
                <a href="#" className="w-12 h-12 border-2 border-white/30 hover:border-white transition-colors flex items-center justify-center" aria-label="Facebook">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                  </svg>
                </a>
                <a href="#" className="w-12 h-12 border-2 border-white/30 hover:border-white transition-colors flex items-center justify-center" aria-label="Twitter">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
                  </svg>
                </a>
                <a href="#" className="w-12 h-12 border-2 border-white/30 hover:border-white transition-colors flex items-center justify-center" aria-label="Instagram">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li><Link href={route("products")} className="text-white/70 hover:text-white transition-colors text-sm">Products</Link></li>
                <li><Link href={route("repair")} className="text-white/70 hover:text-white transition-colors text-sm">Repair Services</Link></li>
                <li><Link href={route("services")} className="text-white/70 hover:text-white transition-colors text-sm">Services</Link></li>
                <li><Link href={route("contact")} className="text-white/70 hover:text-white transition-colors text-sm">Contact</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="text-sm font-bold uppercase tracking-wider mb-6">Services</h4>
              <ul className="space-y-4">
                <li><a href="#" className="text-white/70 hover:text-white transition-colors text-sm">Shoe Repair</a></li>
                <li><a href="#" className="text-white/70 hover:text-white transition-colors text-sm">Custom Fitting</a></li>
                <li><a href="#" className="text-white/70 hover:text-white transition-colors text-sm">Maintenance</a></li>
                <li><a href="#" className="text-white/70 hover:text-white transition-colors text-sm">Consultation</a></li>
              </ul>
            </div>
            <div>
          ...
          <div className="border-t border-white/20 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-white/70 text-sm">&copy; 2024 SoleSpace. All rights reserved.</p>
