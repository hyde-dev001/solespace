    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
      <div className="p-6">
        <div className="flex items-center">
          <div className={`p-3 rounded-full bg-gradient-to-br ${getColorClasses()}`}>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <MetricCard
            title="Total Admins"
            value={stats.total || admins.length}
            icon={UserCircleIcon}
            color="info"
          ...
          <MetricCard
            title="Active Admins"
            value={stats.active || admins.filter(a => a.status === 'active' || a.status === 'approved').length}
          ...
          <MetricCard
            title="Suspended"
            value={stats.suspended || admins.filter(a => a.status === 'suspended').length}
            icon={LockIcon}
            color="warning"
          ...
          <MetricCard
            title="Inactive"
            value={stats.inactive || admins.filter(a => a.status === 'inactive').length}
            icon={AlertIcon}
            color="error"
...
AdminManagement.layout = (page) => <SuperAdminLayout auth={page.props.auth}>{page}</SuperAdminLayout>;
