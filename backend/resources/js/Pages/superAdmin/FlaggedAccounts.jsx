...
const FlaggedAccounts = () => {
  ...
  const [flaggedAccounts, setFlaggedAccounts] = useState([
    {
      id: '1',
      username: 'user_suspicious_123',
      email: 'suspicious@example.com',
      flaggedReason: 'Multiple failed login attempts',
      flaggedDate: '2024-01-15T10:30:00Z',
      status: 'pending_review',
    },
    {
      id: '2',
      username: 'shop_owner_fake',
      email: 'fake@domain.com',
      flaggedReason: 'Reported for fraudulent activity',
      flaggedDate: '2024-01-12T14:20:00Z',
    ...
    },
    {
      ...
      flaggedReason: 'Unusual bulk upload activity',
      flaggedDate: '2024-01-10T09:15:00Z',
      status: 'pending_review',
    },
    {
      id: '4',
...
FlaggedAccounts.layout = (page) => <SuperAdminLayout auth={page.props.auth}>{page}</SuperAdminLayout>;
