  ...
  return (
    <>
      ...
      <div className="space-y-6">
        {/* Header */}
        <div>
          <h3 className="text-2xl font-bold text-gray-800 dark:text-white">User Access Control</h3>
          <p className="mt-1 text-gray-500 dark:text-gray-400">Manage users, roles, and permissions with ease</p>
        </div>
...
UserAccessControl.layout = (page) => <ShopOwnerLayout auth={page.props.auth}>{page}</ShopOwnerLayout>;
