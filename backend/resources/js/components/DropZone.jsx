...
const DropZone = ({ onDrop, inputId, accept = "image/png, image/jpeg" }) => {
  const [isDragActive, setIsDragActive] = useState(false);
  const generatedId = useId();
  const resolvedId = inputId || `dropzone-${generatedId}`;
  ...
  return (
    <div className="transition border border-gray-300 border-dashed cursor-pointer rounded-xl hover:border-blue-500">
      ...
      >
        ...
        <label htmlFor={resolvedId} className="flex flex-col items-center m-0 cursor-pointer">
          <div className="mb-6 flex justify-center">
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gray-200 text-gray-700">
              <svg
