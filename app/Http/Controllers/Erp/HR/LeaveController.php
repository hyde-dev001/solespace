...
class LeaveController extends Controller
{
    ...
    public function approve(Request $request, $id): JsonResponse
    {
        ...
        // Business Logic: Check leave balance
        ...
        $leaveBalance->deductLeave($leaveRequest->leaveType, $leaveRequest->noOfDays);

        // Audit log
        $this->auditApproved(
            AuditLog::MODULE_LEAVE,
            $leaveRequest,
            "Leave request approved: {$leaveRequest->employee->first_name} {$leaveRequest->employee->last_name} - {$leaveRequest->leaveType} leave for {$leaveRequest->noOfDays} days",
            ['workflow', 'approval']
        );
