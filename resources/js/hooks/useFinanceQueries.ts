...
export function useJournalEntries() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const response = await api.get('/api/finance/journal-entries');
      if (!response.ok) {
...
export function useCreateJournalEntry() {
  ...
  return useMutation({
    mutationFn: async (data: Partial<JournalEntry>) => {
      const response = await api.post('/api/finance/journal-entries', data);
      if (!response.ok) {
...
export function useBudgetUtilization() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const response = await api.get('/api/finance/budgets/utilization');
      if (!response.ok) {
...
export function usePendingApprovals() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const response = await api.get('/api/finance/approvals/pending');
      if (!response.ok) {
