    ...
    return (
        <AppLayoutERP>
            ...
            <div className="py-8 px-6">
                ...
                {/* Approval Summary and Recent Activities */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    <ApprovalSummaryWidget approvalSummary={statsData.approvalSummary} />
                    <RecentActivitiesWidget activities={statsData.recentActivities} />
                </div>
