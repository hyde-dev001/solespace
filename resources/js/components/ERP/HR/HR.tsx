...
type Section = "overview" | "employees" | "attendance" | "view-attendance" | "payroll" | "payroll-view" | "payroll-generate" | "leave" | "performance";
...
export default function HRPage() {
  ...
  const section: Section = useMemo(() => {
    ...
    if (["overview", "employees", "attendance", "view-attendance", "payroll", "payroll-view", "payroll-generate", "leave", "performance"].includes(value)) {
