...
export function LeaveRequests() {
  const [leaveRequestsState, setLeaveRequestsState] = useState<LeaveRequest[]>(mockLeaveRequests);
  ...
  }, [leaveRequestsState, searchTerm, selectedStatus, selectedLeaveType]);
  ...
  // Calculate stats
  const stats = {
    total: leaveRequestsState.length,
