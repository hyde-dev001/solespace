...
const ViewAttendance: React.FC = () => {
  ...
  useEffect(() => {
    ...
    fetchAttendance();
  }, [filterMonth, selectedDepartment, selectedStatus, currentPage, itemsPerPage]);
