...
export default function RepairStatusPage() {
  ...
  return (
    <AppLayoutERP>
      <Head title="Repair Status - Solespace ERP" />
      {error && <ErrorModal message={error} onClose={() => setError(null)} />}
      <div className="p-6">
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 shadow-sm">
          <h1 className="text-2xl font-semibold mb-2">Repair Status</h1>
          <p className="text-gray-600 dark:text-gray-400">This is the Repair Status page placeholder.</p>
        </div>
      </div>
    </AppLayoutERP>
  );
