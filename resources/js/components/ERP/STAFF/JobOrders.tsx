...
export default function JobOrdersPage() {
  ...
  const handleProcessOrder = async (order: Order) => {
    const result = await Swal.fire({
      ...
      text: `Order ${order.id} for ${order.customer}`,
      icon: "question",
    ...
    try {
      ...
      await Swal.fire({
        ...
        text: `Order ${order.id} is now Processing.`,
        icon: "success",
  ...
  const handleConfirmShipping = async () => {
    ...
    try {
      // Update order locally; TODO: replace with API persistence
      setOrders((prev) =>
        prev.map((o) =>
      ...
      await Swal.fire({ title: "Order Shipped", text: `Order ${selectedOrder.id} marked as shipped.`, icon: "success", confirmButtonColor: "#2563eb" });
      ...
      await Swal.fire({ title: "Failed", text: "Unable to mark as shipped. Try again.", icon: "error", confirmButtonColor: "#2563eb" });
    }
  };
      ...
      <div className="space-y-6">
        ...
        {isShippingModalOpen && selectedOrder && (
          <div className="fixed inset-0 z-[999999] bg-black/60 backdrop-blur-sm flex items-center justify-center px-4">
            <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-4xl w-full p-6">
              <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Ship Order</h2>
...
const sampleOrders: Order[] = [
  { 
    ...
    product: 'Adidas 450 - Size 9', 
    quantity: 1,
    total: '₱1,600',
    paymentStatus: 'paid',
    status: 'pending',
    shippingAddress: '123 Main St, Makati City, Metro Manila',
    orderedAt: '2026-01-31 10:30 AM'
  },
  { 
    id: 'ORD-20260131002', 
    customer: 'Bob Smith', 
    ...
    product: 'New Balance 550 - Size 10', 
    quantity: 2,
    total: '₱3,200',
    paymentStatus: 'paid',
    status: 'processing',
    shippingAddress: '456 Elm Ave, Quezon City, Metro Manila',
    processedAt: '2026-01-31 11:00 AM',
    orderedAt: '2026-01-31 09:15 AM'
  },
  { 
    id: 'ORD-20260130003', 
    ...
    product: 'Adidas Samba - Size 8', 
    quantity: 1,
    total: '₱1,600',
    paymentStatus: 'paid',
    status: 'shipped',
    shippingAddress: '789 Oak Rd, Pasig City, Metro Manila',
    eta: 'February 2, 2026',
    processedAt: '2026-01-30 02:00 PM',
    shippedAt: '2026-01-30 04:30 PM',
    orderedAt: '2026-01-30 01:00 PM'
  },
  { 
    id: 'ORD-20260129004', 
    ...
    product: 'Loafers - Size 7', 
    quantity: 1,
    total: '₱1,600',
    paymentStatus: 'paid',
    status: 'delivered',
    shippingAddress: '321 Pine St, Taguig City, Metro Manila',
    eta: 'January 31, 2026',
    processedAt: '2026-01-29 10:00 AM',
    shippedAt: '2026-01-29 03:00 PM',
    orderedAt: '2026-01-29 08:00 AM'
  },
  { 
    id: 'ORD-20260131005', 
    ...
    product: 'New Balance 450 - Size 11', 
    quantity: 1,
    total: '₱1,600',
    paymentStatus: 'paid',
    status: 'pending',
    shippingAddress: '654 Cedar Ln, Mandaluyong City, Metro Manila',
    orderedAt: '2026-01-31 12:00 PM'
  },
];
