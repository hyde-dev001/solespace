...
type Section = "chart-of-accounts" | "journal-entries" | "invoice-generation" | "create-invoice" | "expense-tracking" | "financial-reporting" | "budget-analysis" | "reconciliation";
...
export default function FinancePage() {
  ...
  const section: Section = useMemo(() => {
    ...
    if (typeof window !== 'undefined') {
      ...
      if (["chart-of-accounts", "journal-entries", "invoice-generation", "create-invoice", "expense-tracking", "financial-reporting", "budget-analysis", "reconciliation"].includes(value)) return value as Section;
