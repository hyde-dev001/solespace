...
export default function ShoePriceApproval() {
  const [requests, setRequests] = useState<PriceRequest[]>(initialPendingRequests);
  ...
  const handleApprove = async (request: PriceRequest) => {
    ...
    if (result.isConfirmed) {
      ...
      Swal.fire({
        title: "Approved!",
        text: "The price change has been approved successfully.",
        icon: "success",
  ...
  const handleReject = async (request: PriceRequest) => {
    ...
    if (reason) {
      ...
      Swal.fire({
        title: "Rejected",
        text: "The price change has been rejected.",
        icon: "info",
        confirmButtonColor: "#2563eb",
      });
    }
    ...
    <>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div>
            <h1 className="text-2xl font-semibold mb-1 text-gray-900 dark:text-white">Shoe Price Approvals</h1>
            <p className="text-gray-600 dark:text-gray-400">Review and approve shoe pricing change requests</p>
          </div>
          ...
          <div className="fixed inset-0 z-[999999] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Price Change Request Details</h2>
                <button
