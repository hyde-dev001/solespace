                  ...
                  <div className="p-8">
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-200">
                      {order.status === 'ready_for_pickup' && (
                        <div className="w-full border border-black text-black px-8 py-4 text-center font-medium text-sm tracking-wide uppercase">
                          Ready for Pickup
                        </div>
                      )}
                      {order.status === 'picked_up' && (
                        <div className="w-full border-2 border-black text-black px-8 py-4 text-center font-medium text-sm tracking-wide uppercase">
                          ✓ Item Picked Up
                        </div>
                      )}
                      {order.status === 'pending' && (
                        <div className="w-full border border-gray-300 text-gray-600 px-8 py-4 text-center font-medium text-sm tracking-wide uppercase">
                          Awaiting Assessment
                        </div>
                      )}
