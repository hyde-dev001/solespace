        ...
        <div className="max-w-[1920px] mx-auto px-6 lg:px-12 py-12 lg:py-20">
          ...
          <div className="mb-12">
            <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              {services.map((s) => (
                <div key={s.id} className="group block bg-white rounded-lg border border-gray-100 p-4 hover:shadow-lg transition-shadow duration-150">
                  ...
                  <div className="text-center mt-4">
                    <div className="text-sm text-black/80 font-medium">{s.shopName}</div>
                    <div className="text-xs text-black/50 mt-1">{s.shopLocation} • {s.shopRating} ⭐</div>
                    <div className="mt-3">
                      <button className="px-4 py-2 border border-black text-black text-sm rounded hover:bg-black hover:text-white transition">Request</button>
                    </div>
                  </div>
                </div>
              ))}
