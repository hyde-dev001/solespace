...
const ProductShow: React.FC = () => {
  ...
  // Ensure images array is properly set up - use images array or fallback to primary
  ...
  const [selectedColor, setSelectedColor] = useState<string | null>(() => {
    const colors = product.colors_available || product.colors || [];
          ...
          <div className="flex gap-8">
                ...
                <div className="mt-6 flex items-center gap-3 overflow-x-auto pb-2">
                  {images.map((img: string, idx: number) => (
                    <button 
                      ...
                      className={`w-20 h-20 rounded border ${selectedImage === img ? 'border-black border-2' : 'border-gray-200'} bg-white flex items-center justify-center flex-shrink-0 hover:border-gray-400 transition-colors`}
                    >
                      <img src={img} alt={`Product view ${idx + 1}`} className="max-w-full max-h-full object-contain" />
                    </button>
                  ))}
                </div>
              )}
            ...
            <div className="w-[420px]">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {(product.colors_available || product.colors).map((color: string) => {
                      // Get images for this color from variants
              ...
              <div className="mt-8 border-t pt-6">
                ...
                <div className="text-sm font-medium mb-4"><a href={`/shop-profile/${product.shop?.id}`} className="underline text-black hover:text-gray-700 transition-colors">{product.shop?.name}</a></div>
            ...
            <div className="border-t pt-12">
              <div className="flex items-center justify-between mb-8">
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex items-center gap-2">
                      <span className="text-3xl font-bold text-black">0.0</span>
              ...
              <div className="bg-gray-50 rounded-xl p-6 mb-8">
                ...
                <div className="mb-6">
                  <label className="block text-sm font-medium text-black mb-2">Photos (Optional)</label>
