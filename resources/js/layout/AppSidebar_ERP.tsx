  ...
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <path d="M5 20v-1a4 4 0 014-4h6a4 4 0 014 4v1" />
      </svg>
    ),
    name: "Approvals",
    route: "erp.manager.approvals",
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <path d="M5 20v-1c0-1.66 3.58-3 8-3s8 1.34 8 3v1" />
      </svg>
    ),
    name: "User Management",
    route: "erp.manager.user-management",
  },
];
    ...
    (routeName: string, params?: Record<string, any>, extraPaths?: string[]) => {
      try {
        ...
        if (routeName && routeName.startsWith && routeName.startsWith("erp.staff.")) {
          ...
          if (url === staffPath || url.startsWith(staffPath)) return true;
